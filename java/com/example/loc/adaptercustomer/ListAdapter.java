...
/**
 * Created by LOC on 10/7/2016.
 */

public class ListAdapter extends ArrayAdapter<ThongSo> {

    public ListAdapter(Context context, int resource, List<ThongSo> items) {
